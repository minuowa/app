...
void GTrailEffect::Update()
{
    ...
    {
        D3DXVECTOR3 v1 ( mLinker1->mTransform->_41, mLinker1->mTransform->_42, mLinker1->mTransform->_43 );
        D3DXVECTOR3 v2 ( mLinker2->mTransform->_41, mLinker2->mTransform->_42, mLinker2->mTransform->_43 );
